...
//   const toggleHamburgerMenu = () => setHamburgerMenuOn(!hamBurgerMenuOn);
//   const closeHamburgerMenu = () => setHamburgerMenuOn(false);
...
//         <div
//           className="fixed top-0 left-0 w-full h-full backdrop-blur-sm z-40"
//           onClick={closeHamburgerMenu} // Click outside to close sidebar
//         ></div>
//       )}

//       {/* Sidebar Menu */}
//       <div
//         className={`fixed top-0 left-0 z-50 w-[320px] h-full transition-all duration-500 ease-out bg-white border border-gray-300 ${
//           hamBurgerMenuOn ? "translate-x-0" : "-translate-x-full"
//         }`}
//       >
//         {/* Header */}
//         <header className="bg-white px-3 h-[10%] flex items-center justify-between">
...
//             <span>Hello {loggedInUser ? loggedInUser.userName : "User"}</span>
//           </span>
//           <span onClick={closeHamburgerMenu}>
//             <CancelIcon className="cursor-pointer" />
//           </span>
//         </header>

//         {/* Navigation Links */}
//         <div className="h-[90%] bg-gray-100 flex flex-col px-3">
...
//             </span>
//           </Link>
//           <Link to={`/product`} onClick={closeHamburgerMenu}>
//             <span className="h-14 flex items-center">
//               <CategoryIcon />
//               <span className="ml-2">boAt Products</span>
//             </span>
//           </Link>
//           <Link to={`/about`} onClick={closeHamburgerMenu}>
//             <span className="h-14 flex items-center">
//               <InfoIcon />
//               <span className="ml-2">Contact</span>
//             </span>
