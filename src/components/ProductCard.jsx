...
export default function ProductCard({
  ...
  let addToCart = (e, product) => {
    ...
    e.stopPropagation(); // Parent div ke onClick ko trigger hone se rokne ke liye
  ...
  // Naigation & Product Detail Send to other Page
  ...
  return (
    <div className="max-w-[1400px] w-full h-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 place-items-center mx-auto px-10 mt-10 max-md:px-3">
      {products.map((product) => (
        <div
          className="w-full max-w-[400px] h-[200px] border border-gray-300 p-2 rounded-xl flex  gap-3 bg-[rgb(250,250,250)] max-md:mx-auto cursor-pointer"
          key={product.id}
